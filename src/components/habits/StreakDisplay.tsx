...
export function StreakDisplay({ todayProgress, totalHabits }: StreakDisplayProps) {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-habit/15 bg-habit-soft p-4 sm:p-5 animate-fade-up">
      <div className="flex items-center gap-4 sm:gap-5">
        <div className="relative shrink-0">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <span className="text-xl sm:text-2xl font-bold text-ink tabular-nums">{todayProgress}%</span>
          </div>
        </div>
        <div>
          <h3 className="font-display text-lg sm:text-xl text-ink">Today&apos;s Progress</h3>
