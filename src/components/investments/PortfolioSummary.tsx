...
export function PortfolioSummary({ totalInvested, totalCurrentValue, totalPnL, pnlPercent }: PortfolioSummaryProps) {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl bg-invest p-4 sm:p-6 animate-fade-up shadow-xl shadow-invest/10">
      ...
      <div className="relative">
        ...
        <p className="mt-2 text-2xl sm:text-4xl font-bold text-white tabular-nums tracking-tight font-display">{formatCurrency(totalCurrentValue)}</p>

        <div className="mt-4 sm:mt-5 grid grid-cols-2 gap-3 sm:gap-4 border-t border-white/10 pt-3 sm:pt-4">
          <div>
